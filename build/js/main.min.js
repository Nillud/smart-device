...
var pageBody = document.querySelector('[data-body]');
var buttonRequest = document.querySelector('[data-request-button]');
var modalRequest = document.querySelector('[data-modal]');
var buttonClose = document.querySelectorAll('[data-close-modal]');
var scrollButton = document.querySelector('[data-scroll-button]');
var questionsBlock = document.querySelector('[data-questions]');
var buttonMore = document.querySelector('[data-button-more]');
var aboutDescription = document.querySelector('[data-description]');
var aboutMobile = document.querySelector('[data-description-mobile');
var accordeonSections = document.querySelector('[data-accordeon-sections]');
var accordeonContacts = document.querySelector('[data-accordeon-contacts]');

// const form = document.querySelector('[data-form]');
var submitButton = document.querySelector('[data-submit]');
var modalSubmitButton = document.querySelector('[data-form-submit]');
var nameInput = document.querySelector('[data-name]');
var nameInputModal = document.querySelector('[data-name-modal');
var phoneInput = document.querySelector('[data-phone]');
var phoneInputModal = document.querySelector('[data-phone-modal]');
var maskOptions = {
  mask: '+{7}(000)000 00 00',
  lazy: false
};
var focusableEls = modalRequest.querySelectorAll('a[href]:not([disabled]), button:not([disabled]), textarea:not([disabled]), input[type="text"]:not([disabled]), input[type="radio"]:not([disabled]), input[type="checkbox"]:not([disabled]), select:not([disabled])');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var phoneMask = new imask__WEBPACK_IMPORTED_MODULE_2__["default"](phoneInput, maskOptions);
  var phoneMaskModal = new imask__WEBPACK_IMPORTED_MODULE_2__["default"](phoneInputModal, maskOptions);
  ...
  phoneInputModal.addEventListener('load', function () {
    phoneMaskModal();
  });
  ...
  if (accordeonSections) {
    ...
    accordeonSections.addEventListener('click', function () {
  ...
  if (accordeonContacts) {
    ...
    accordeonContacts.classList.add('inactive');
    accordeonContacts.addEventListener('click', function () {
