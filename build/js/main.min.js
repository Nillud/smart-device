...
/* harmony import */ var _mask__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mask */ "./js/mask.js");




// ---------------------------------
var BUTTON_NOJS = document.querySelectorAll('[data-button]');
var REQUEST_BUTTON = document.querySelector('[data-request-button]');
var MODAL_REQUEST = document.querySelector('[data-modal]');
var SRCOLL_BUTTON = document.querySelector('[data-scroll-button]');
var QUESTIONS_BLOCK = document.querySelector('[data-questions]');
var BUTTON_MORE = document.querySelector('[data-button-more]');
var ABOUT_DESCRIPTION = document.querySelector('[data-description]');
var ABOUT_MOBILE = document.querySelector('[data-description-mobile');
var ACCORDEON_FIELDS = document.querySelectorAll('[data-accordeon-field]');
var SUBMIT_BUTTON = document.querySelector('[data-form-submit]');
var MODAL_SUBMIT_BUTTON = document.querySelector('[data-modal-submit]');
var NAME_INPUT = document.querySelector('[data-name]');
var NAME_INPUT_MODAL = document.querySelector('[data-name-modal');
var PHONE_INPUT = document.querySelector('[data-phone]');
var PHONE_INPUT_MODAL = document.querySelector('[data-phone-modal]');
var QUESTION_INPUT = document.querySelector('[data-form-question]');
var QUESTION_INPUT_MODAL = document.querySelector('[data-form-question-modal]');
var pageLoad = function pageLoad() {
  REQUEST_BUTTON.href = '#';
  SRCOLL_BUTTON.href = '#';
  PHONE_INPUT.removeAttribute('pattern');
  PHONE_INPUT_MODAL.removeAttribute('pattern');
  BUTTON_NOJS.forEach(function (button) {
    button.classList.remove('no-js');
  });
  ABOUT_DESCRIPTION.classList.remove('is-active');
  ABOUT_MOBILE.classList.remove('is-active');
};
var closeAccordeons = function closeAccordeons() {
  ACCORDEON_FIELDS.forEach(function (field) {
    field.classList.remove('is-active');
    field.classList.add('inactive');
  });
};
var openAccordeon = function openAccordeon(field) {
...
var validatePhone = function validatePhone(input, submit) {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  pageLoad();
  var setDataToStore = function setDataToStore() {
  ...
  PHONE_INPUT.addEventListener('input', function () {
    Object(_mask__WEBPACK_IMPORTED_MODULE_2__["addMask"])(PHONE_INPUT);
  });
  PHONE_INPUT.addEventListener('change', function () {
    validatePhone(PHONE_INPUT, SUBMIT_BUTTON);
  });
  PHONE_INPUT_MODAL.addEventListener('input', function () {
    Object(_mask__WEBPACK_IMPORTED_MODULE_2__["addMask"])(PHONE_INPUT_MODAL);
  });
  PHONE_INPUT_MODAL.addEventListener('change', function () {
  ...
  SRCOLL_BUTTON.addEventListener('click', function (e) {
    if (SRCOLL_BUTTON) {
      e.preventDefault();
...
/*!********************!*\
  !*** ./js/mask.js ***!
  \********************/
/*! exports provided: addMask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addMask", function() { return addMask; });
